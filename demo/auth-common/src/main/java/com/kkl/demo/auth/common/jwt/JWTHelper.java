package com.kkl.demo.auth.common.jwt;
...
public class JWTHelper {
    ...
    public static IJWTInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
        ...
        return new User(Long.parseLong(StringHelper.getObjectValue(body.get("JWT_KEY_USER_ID"))), StringHelper.getObjectValue(body.get("JWT_KEY_NAME")));
    }
    /**
     * 获取token中的用户信息
     *
